...
המשימה: הרכב את לוח האירועים לחודש ${month} — 4 עד ${MAX_EVENTS} אירועי המקרו הגדולים באמת.

צ'קליסט חובה (Yoav 14.7 — אירועים עתירי-השפעה שנעדרו מהלוח = תקלה): לפני שאתה מחזיר, ודא שכל אחד מאלה שמתקיים בחודש הזה אכן נכלל, ואם השמטת — נמק בשדה נפרד למה:
1. פרסום ה-CPI האמריקאי (תמיד באמצע החודש — bls.gov)
2. פרסום המדד הישראלי (ב-15 לחודש, 18:30 — למ"ס)
3. החלטת ריבית של הפד אם יש באותו חודש (federalreserve.gov)
4. החלטת ריבית בנק ישראל אם יש (boi.org.il)
5. דוח התעסוקה האמריקאי (יום שישי הראשון)
6. פתיחת עונת דוחות אם חלה בחודש — יום הדיווח המרוכז של הבנקים הגדולים (JPMorgan/BofA/וולס פארגו/סיטי/גולדמן, אמצע ינואר/אפריל/יולי/אוקטובר)
7. דוחות ענקיות טכנולוגיה שמתפרסמים בחודש (אפל/מיקרוסופט/אנבידיה/טסלה/גוגל/מטא)
