...
const CONTENT = {
  he: {
    ...
    termsSections: [
      ...
      { title: "4. הגבלת גיל, כשירות משפטית ואישור הורה לרכישות של קטינים", body: "השימוש החינוכי באפליקציה מותר מגיל 16 ומעלה. מתחת לגיל 16 — אין הרשמה. מימוש הטבות מול גופים פיננסיים חיצוניים מוגבל למשתמשים בני 18 ומעלה בלבד.\n\nרכישת מנוי Pro על ידי קטין (בני 16–17) — לפי חוק הכשרות המשפטית והאפוטרופסות, התשכ\"ב-1962 (סע' 4–6), עסקה מתמשכת של קטין מחייבת אישור הורה. לצורך כך מובנה באפליקציה תהליך אישור הורה: הקטין מזין אימייל של הורה, FinPlay שולחת להורה אימייל עם קישור אישור, וההורה מאשר/דוחה ישירות מהאימייל. רכישת Pro תיפתח לקטין רק לאחר שההורה אישר. ההורה רשאי לחזור בו מהסכמתו בכל עת באמצעות קישור הביטול שבאותו אימייל; ביטול הסכמה אינו מבטל אוטומטית מנוי קיים — לצורך ביטול והחזר יש לפעול ישירות מול App Store / Google Play." },
    ...
    privacySections: [
      ...
      { title: "4. דיוור ישיר והודעות שיווקיות", body: "בעצם הרשמתך, הנך מסכים/ה לקבלת הודעות מערכת, תזכורות למידה, התראות פוש, מסרונים ודברי פרסומת מ-FinPlay ומשותפיה, בהתאם לסעיף 30א לחוק התקשורת (בזק ושידורים), התשמ\"ב-1982. הודעות פרסומיות יסומנו במילה \"פרסומת\" בכותרת ההודעה.\n\nניתן להסיר עצמכם מרשימת התפוצה בכל עת באחת מהדרכים הבאות:\n• דרך הגדרות האפליקציה\n• דרך הגדרות המכשיר (להתראות פוש)\n• דרך לינק \"הסרה מרשימת תפוצה\" שמופיע בכל מייל שיווקי\n• בתגובה לכל מייל עם המילה \"הסר\"\n• בפנייה לכתובת support@finplay.me\n\nההסרה תיכנס לתוקף תוך 3 ימי עסקים." },
      { title: "5. זכויותיך (עיון, תיקון ומחיקה)", body: "על פי חוק הגנת הפרטיות, הינך זכאי/ת לעיין במידע האישי שלך. לעיון, תיקון או מחיקת חשבון, ניתן לפנות אלינו: support@finplay.me" },
