...
const CONTENT = {
  ...
  en: {
    ...
    termsSections: [
      { title: "1. Nature of Service & No Financial Advice", body: "FinPlay is an educational technology platform for learning financial literacy through gamification and simulations. All content, data, indices, and simulators are for learning, practice, and enrichment purposes only.\n\nThe company does not hold a license under the Investment Advice Regulation Law, 5755-1995. No information in the App constitutes financial, pension, tax, or investment advice. Any financial decision you make in the real world is your sole responsibility." },
