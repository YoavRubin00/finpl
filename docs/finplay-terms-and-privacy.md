...
השימוש באפליקציה מותר למשתמשים מגיל 16 ומעלה למטרות חינוכיות (בכפוף לאישור הורה/אפוטרופוס לקטינים). חשיפה להצעות מסחריות ומימוש הטבות מול גופים פיננסיים מוגבלים למשתמשים בני 18 ומעלה בלבד.
