...
export const SEED_QUESTIONS: readonly CrowdWisdomQuestion[] = [
  // ─────────────────────────── SENTIMENT ───────────────────────────
  {
    ...
    contextChip: "ת״א 35 · 2,087 · השבוע +1.4%",
    choices: [
  ...
  // ─────────────────────────── YES/NO ───────────────────────────
  {
    ...
    contextChip: "NVDA · $875.20 · עלתה 5.1% השבוע",
    choices: [
  ...
  },
  {
    ...
    contextChip: "BTC · $97,420 · השבוע +2.3%",
    choices: [
  ...
  },
  {
    ...
    contextChip: "ריבית נוכחית · 4.5% · החלטה בעוד 12 ימים",
    choices: [
  ...
  },
  {
    ...
    contextChip: "TSLA · $244.30 · החודש +12%",
    choices: [
  ...
  // ─────────────────────────── FORECAST ───────────────────────────
  {
    ...
    contextChip: "מדד נוכחי · 2,087 · יום ב' 16:30",
    choices: [
      { id: "below_2050", label: "מתחת ל-2,050", seedVotes: 320, accentColor: "#dc2626" },
      { id: "2050_2080", label: "2,050 – 2,080", seedVotes: 740, accentColor: "#ea580c" },
      { id: "2080_2110", label: "2,080 – 2,110", seedVotes: 1480, accentColor: "#facc15" },
      { id: "2110_2140", label: "2,110 – 2,140", seedVotes: 920, accentColor: "#10b981" },
      { id: "above_2140", label: "מעל 2,140", seedVotes: 280, accentColor: "#0891b2" },
    ],
  ...
  },
  {
    ...
    contextChip: "S&P · 5,820 · YTD +21%",
    choices: [
      { id: "below_5500", label: "מתחת 5,500", seedVotes: 580, accentColor: "#dc2626" },
      { id: "5500_5800", label: "5,500 – 5,800", seedVotes: 920, accentColor: "#ea580c" },
      { id: "5800_6100", label: "5,800 – 6,100", seedVotes: 1820, accentColor: "#facc15" },
      { id: "6100_6400", label: "6,100 – 6,400", seedVotes: 1380, accentColor: "#10b981" },
      { id: "above_6400", label: "מעל 6,400", seedVotes: 410, accentColor: "#0891b2" },
    ],
  ...
  },
  {
    ...
    contextChip: "USD/ILS · 3.68 · החודש -1.2%",
    choices: [
      { id: "below_360", label: "מתחת ל-3.60", seedVotes: 412, accentColor: "#10b981" },
      { id: "360_370", label: "3.60 – 3.70", seedVotes: 980, accentColor: "#facc15" },
      { id: "370_380", label: "3.70 – 3.80", seedVotes: 540, accentColor: "#ea580c" },
      { id: "above_380", label: "מעל 3.80", seedVotes: 188, accentColor: "#dc2626" },
    ],
    seedTotalVoters: 2120,
    closesInHours: 240,
  },
  {
  ...
  },
  {
    ...
    contextChip: "אינפלציה נוכחית · 3.4% · יעד 1-3%",
    choices: [
