...
export const PRICE_SLIDER_ITEMS: PriceSliderItem[] = [
  ...
  },
  {
    ...
    sharkExplanation: 'פי 17 ב-40 שנה — כ-7% אינפלציה ממוצעת. מה שלא מושקע ב-7%+ נשחק מהר יותר ממה שנראה.',
    category: 'transport',
  },
  {
  ...
  },
  {
    ...
    sharkExplanation: 'החלב עלה פי 2.5 ב-30 שנה — זה מחיר מפוקח, אז העלייה מרוסנת. הגדלת החיסכון שלכם חייבת להדביק את האינפלציה — אחרת קונים פחות חלב עם אותה משכורת.',
    category: 'food',
  },
  {
    id: 'ps-falafel-1988',
    ...
    sharkExplanation: 'מחיר המנה התייקר פי ~9 ב-37 שנה. זה כולל אינפלציה כללית וגם עליית ערך הפלאפל בהיררכיית "מותרות" של מזון רחוב.',
    category: 'food',
  },
  {
    id: 'ps-bitcoin-2013',
    ...
    sharkExplanation: 'ביטקוין מ-~600 לכ-360,000 ב-12 שנה — פי ~600. זו דוגמה קיצונית של נכס ספקולטיבי. רוב מי שקנה בראש גל — איבד 70-80% לפני שהתאושש. היסטוריה של מעטים מטושטשת את הסיכון של רוב.',
    category: 'finance',
  },
  {
