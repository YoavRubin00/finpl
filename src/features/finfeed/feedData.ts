...
export const MOCK_FEED_DATA: FeedItem[] = [
  ...
  },
  {
    ...
    description: "כל מה שצריך לדעת על קרן הפנסיה שלכם: מה נכנס, מה יוצא, ואיך לוודא שאתם לא מפסידים כסף.",
    category: "Investing",
  ...
  },
  {
    ...
    description: "נקודות זיכוי, ניכויים, החזר מס, רוב האנשים משלמים יותר ממה שצריך. בואו נתקן את זה.",
    category: "Taxes",
