...
const BASE_ASSETS: Omit<RealAsset, 'purchasedAt' | 'lastCollectedAt'>[] = [
  {
    ...
    name: 'דירה להשכרה',
    emoji: '🏠',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/apartment-4JtXTiqXLiWduiJy1HBAtTxE3dasWB.png' },
    type: 'real_estate',
    tier: 1,
    baseCost: 5_000,
    upgradeCost: 3_000,
  ...
  },
  {
    ...
    name: 'חנות מסחרית',
    emoji: '🏪',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/shop-LiBUPVaHw0FSMVSEY4BTfX3ASIjwtd.png' },
    type: 'commercial',
    tier: 1,
    baseCost: 3_200,
    upgradeCost: 1_920,
  ...
  },
  {
    ...
    emoji: '☀️',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/solar-hfWi1YOhq6zYMAXxdZ60rCUlyELIxO.png' },
    type: 'energy',
    tier: 1,
    baseCost: 1_800,
    upgradeCost: 1_080,
  ...
  },
  {
    ...
    name: 'קרן נדל"ן (REIT)',
    emoji: '🏢',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/reit-GGJ0G42csuiqS7TJdzdpYRnpuoxhUp.png' },
    type: 'reit',
    tier: 1,
    baseCost: 2_500,
    upgradeCost: 1_500,
  ...
  },
  {
    ...
    name: 'תיק דיבידנדים',
    emoji: '📊',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/dividend-6N1whWvEB5T43yp9KuQ6OOc4pgmIU9.png' },
    type: 'dividend',
    tier: 1,
    baseCost: 1_500,
    upgradeCost: 900,
  ...
  },
  {
    ...
    name: 'אג"ח ממשלתי',
    emoji: '🏦',
    image: { uri: 'https://8mnwcjygpqev3keg.public.blob.vercel-storage.com/images/realAssets/gov_bond-yrSnX8di9gSzCMyRDDjhH2txLCZo8k.png' },
    type: 'bond',
    tier: 1,
    baseCost: 800,
    upgradeCost: 480,
