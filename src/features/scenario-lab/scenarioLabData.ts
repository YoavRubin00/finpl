...
export const SCENARIOS: Scenario[] = [
  ...
  // ── 11. בועת הנדל"ן ביפן — 1990 ──
  {
    ...
    historicalNote: 'ניקיי 225 ירד מ-39,000 ב-1989 ל-7,054 ב-2009 — ירידה של 82%. רק בפברואר 2024 הניקיי חזר לשיא של 1989. מחירי הנדל"ן בטוקיו עדיין מתחת לרמות של 1990.',
  },
