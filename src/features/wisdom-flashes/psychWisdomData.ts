...
export const psychWisdomFlashes: PsychWisdomFlash[] = [
    ...
    {
        id: 'pw-3',
        text: 'המוח שלנו מעדיף מידע שמאשר את מה שכבר החלטנו. משקיע חכם מחפש דווקא את המידע שסותר אותו.',
        category: 'cognitive-bias',
        icon: '🧩',
        type: 'psych',
    },
    {
        id: 'pw-4',
        text: 'טעות נשארת טעות גם אם אלפי אנשים עושים אותה יחד. הקהל לא הופך שגיאה לאסטרטגיה.',
        category: 'cognitive-bias',
        icon: '🧩',
        type: 'psych',
    },
    ...
    {
        id: 'pw-7',
        text: 'פחד וחמדנות הם שני הכוחות הכי חזקים בשוק. שניהם עובדים נגדך אם אתה לא מזהה אותם.',
        category: 'emotional-control',
        icon: '🎭',
        type: 'psych',
    },
    ...
    {
        id: 'pw-12',
        text: 'לרכוש מניה בלי להבין מה החברה עושה, זה כמו לשים כסף במעטפה ולזרוק אותה מהחלון.',
        category: 'discipline',
        icon: '📏',
        type: 'psych',
    },
    ...
    {
        id: 'pw-15',
        text: 'כשהשוק עולה, כולם מרגישים גאונים. המבחן האמיתי הוא איך אתה מתנהל כשהוא יורד.',
        category: 'contrarian',
        icon: '🔄',
        type: 'psych',
    },
    ...
    {
        id: 'pw-17',
        text: 'אנשים מוכנים לקחת סיכון גדול כדי להימנע מהפסד, אבל נהיים שמרנים כשמדובר ברווח. זה בדיוק ההפך ממה שצריך.',
        category: 'money-psychology',
        icon: '💭',
        type: 'psych',
    },
    {
        id: 'pw-18',
        text: 'הכסף שהפסדת כואב יותר מהכסף שהרווחת משמח. הכרה בעובדה הזו היא הצעד הראשון לקבלת החלטות טובות יותר.',
        category: 'money-psychology',
        icon: '💭',
        type: 'psych',
    },
    ...
    {
        id: 'pw-21',
        text: 'להשקיע בהצלחה זה לא עניין של מזל או תחושות בטן. זה עניין של שיטה, סבלנות, ולמידה מתמדת.',
