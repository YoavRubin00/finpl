...
const CATEGORY_SHARK_INTRO: Record<StockCategoryId, string> = {
  ...
  energy: 'מניות ערך זה הליבה של תיק מאוזן — מותגים חזקים, דיבידנדים יציבים. הניתוח שלי:',
  ...
  hype: 'טרנד והייפ — המגרש הכי תנודתי במשחק. מה שחם היום יכול להתקרר מחר, אז נכנסים בעיניים פקוחות. הניתוח שלי:',
};
