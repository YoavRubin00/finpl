...
export const ISRAELI_CALLOUT_DETAIL =
  'קופת גמל להשקעה מאפשרת הפקדה של עד ₪81,711 בשנה (2024). הרווחים ממוסים ב-25% בפדיון. פטור ממס רק אם מושכים כקצבה חודשית בגיל 60+; משיכה חד-פעמית עדיין חייבת ב-25% על הרווח הריאלי.';
