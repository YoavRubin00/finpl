...
export const TOOL_TUTORIALS: Partial<Record<ToolKey, ToolTutorialStep[]>> = {
  // ── Israel-2026 trends pass (Yoav 18.9.26) — copy only, audio pending ──
  miluim: [
    { title: 'הכסף של המילואים', emoji: '🎖️', message: 'שירתתם השנה? מגיעות לכם נקודות זיכוי, מענקים והטבות. רוב האנשים לא מממשים.' },
    { title: 'איך זה עובד', emoji: '🛠️', message: 'הזיזו את ימי השירות ובחרו סוג שירות. אני אראה לכם כמה זה שווה בשקלים ומה לדרוש.' },
    { title: 'טיפ', emoji: '💡', message: 'נקודות זיכוי לא נכנסות לבד. מעדכנים טופס 101 או מגישים דוח, ואפשר לדרוש שש שנים אחורה.' },
  ],
  'rent-vs-buy': [
    { title: 'לשכור או לקנות', emoji: '🔑', message: 'השאלה הכי גדולה בכסף של צעירים בישראל. כאן עונים עליה במספרים, לא בדעות.' },
    { title: 'איך זה עובד', emoji: '🛠️', message: 'שני המסלולים מתחילים מאותו הון עצמי. אחד קונה, השני שוכר ומשקיע את ההפרש. משווים אחרי כמה שנים.' },
    { title: 'טיפ', emoji: '💡', message: 'שנו את עליית ערך הדירה ואת תשואת ההשקעה ותראו כמה מהר המנצח מתחלף.' },
  ],
  'bet-vs-invest': [
    { title: 'הימור מול השקעה', emoji: '🎲', message: 'אותו סכום כל שבוע. פעם אחת להימורי ספורט, פעם אחת לתעודת סל. בואו נראה מה קורה.' },
    { title: 'איך זה עובד', emoji: '🛠️', message: 'בהימורים הבית שומר אחוז קבוע מכל שקל. בהשקעה הכסף עובד ומצטבר. ההפרש אחרי שנים מפתיע.' },
    { title: 'טיפ', emoji: '💡', message: 'הזכייה של השכן היא הסטטיסטיקה, לא היוצא מן הכלל. המספרים כאן הם הממוצע לאורך זמן.' },
  ],
  payslip: [
