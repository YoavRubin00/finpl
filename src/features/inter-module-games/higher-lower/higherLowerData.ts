...
export const HIGHER_LOWER_SCENARIOS: HigherLowerScenario[] = [
  {
    ...
    correctSide: 'right',
    explanation: '2,000 ₪ בחודש ב-S&P 500 הופכים אחרי 25 שנה ל-1.62M ₪. המיליון במזרן? אינפלציה אוכלת אותו.',
  ...
  },
  {
    ...
    correctSide: 'left',
    explanation: 'יוסי הפקיד שליש ממשה, ובכל זאת ניצח: 3.1M מול 2.85M. הכסף שלו פשוט צמח 33 שנה יותר.',
  ...
  },
  {
    ...
    correctSide: 'right',
    explanation: 'ETF מפוזר הופך 100K ל-761K ב-30 שנה. קריפטו יכול לעוף פי 40 או להתמוסס ב-95%. לפנסיה בוחרים ודאות, לא הימור.',
  ...
  },
  {
    ...
    correctSide: 'left',
    explanation: 'חוב ב-14% = הפסד מובטח של 14% בשנה. פירעון חוסך 46K, השקעה ב-7% תרוויח רק 20K. תפרעו חוב יקר לפני שתשקיעו.',
  ...
  },
  {
    ...
    correctSide: 'right',
    explanation: '2% דמי ניהול מול 0.1% = הפרש של 700K ₪ אחרי 30 שנה. ו-85% מהקרנות האקטיביות לא מכות את המדד בכלל.',
  ...
  },
  {
    ...
    correctSide: 'right',
    explanation: 'התאמת מעסיק = 100% תשואה מיידית על כל שקל. לא לקחת אותה זה לזרוק כסף חינם, אחרי 30 שנה הפרש של 1.13M ₪.',
  ...
  },
  {
    ...
    correctSide: 'left',
    explanation: 'בתל אביב, היסטורית, בעל הדירה מגיע ל-4.5M והשוכר שהשקיע את ההפרש ל-3.4M. אבל זו היסטוריה בלבד, אין ערובה שתחזור.',
  ...
  },
  {
    ...
    correctSide: 'right',
    explanation: 'חיסכון בבנק ממוסה תמיד. קופת גמל במסלול מנייתי פטורה ממס אם מושכים כקצבה בגיל 60+. ב-20 שנה ההפרש מגיע ל-1.26M ₪.',
