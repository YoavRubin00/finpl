...
const UPGRADE_COPY: Record<GatedFeature | 'default', CopyPool> = {
  ...
  "analyst-deep": [
    { title: "🔍 ניתוח עומק נעול", body: "follow-up, תזרימים, בדיקות שווי — הכל זמין ב‑PRO" },
    { title: "🧠 רוצים את הפרטים הקטנים?", body: "ניתוח העומק עם כל המידע שמור ל‑PRO. שדרגו ותקבלו אנליסט מלא" },
  ],
  default: [
