...
const UPGRADE_COPY: Record<GatedFeature | 'default', CopyPool> = {
  ...
  "lesson-report": [
    { title: "📋 דוח סיכום השיעור שלכם מוכן", body: "ניצלתם את הדוח השבועי החינמי. ב‑PRO מקבלים דוח הבנה אחרי כל שיעור" },
    { title: "📝 קפטן שארק סיכם איך הלך לכם", body: "דוח ההבנה השבועי נוצל. שדרגו ל‑PRO לדוח מלא אחרי כל מודולה + שיחה על הדוח" },
  ],
  default: [
