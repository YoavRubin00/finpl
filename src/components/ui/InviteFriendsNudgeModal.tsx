...
const DAILY_COPY: Record<number, string> = {
  ...
  2: 'כל הזמנה = מטבעות לכם, וסטארט לחבר',
  3: 'אמצע שבוע — הזמנה אחת ושניכם נהנים',
  4: 'סוף השבוע מתקרב, שווה להזמין חברים שילמדו איתכם',
  5: 'שישי שמח, הזמנה לחבר/ה לפני שבת',
      ...
      <View style={styles.overlay}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            להזמין חבר/ה = מטבעות לכם, סטארט סופר לחבר. הכי כיף ביחד.
          </Text>
