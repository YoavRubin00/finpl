...
const popupStyles = StyleSheet.create({
  ...
  progressTrack: {
    ...
    height: 10,
    borderRadius: 999,
    backgroundColor: STITCH.progressTrack,
    overflow: "hidden",
    transform: [{ scaleX: -1 }],
  },
  progressFill: {
    height: "100%",
    borderRadius: 999,
    backgroundColor: STITCH.progressFill,
  },
  xpText: {
    fontSize: 13,
    fontWeight: "700",
    color: STITCH.primaryCyanDim,
    writingDirection: "rtl",
  },
  xpTotal: {
    fontSize: 12,
...
const s = StyleSheet.create({
  ...
  profileBannerCompact: {
    ...
    gap: 8,
    borderWidth: 1.5,
    borderColor: STITCH.surfaceVariant,
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.05,
    shadowRadius: 3,
  ...
  plusBtn: {
    ...
    height: 16,
    borderRadius: 8,
    backgroundColor: STITCH.successAccent,
    justifyContent: "center",
    alignItems: "center",
    marginLeft: 2,
    shadowColor: STITCH.successAccent,
    shadowOpacity: 0.35,
    shadowRadius: 3,
    shadowOffset: { width: 0, height: 2 },
    elevation: 4,
